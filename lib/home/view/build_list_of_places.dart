...
SliverList buildListOfPlaces(String textFieldText, List<PlacesDetail> places, String googleApiKey,BuildContext context) {
  return SliverList(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
                  ...
                  places[index].types.isNotEmpty
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder:
                            (BuildContext context, int indexTypes) {
                          return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        places[index].priceLevel.isNotEmpty &&
                            ...
                            ? Text(places[index].priceLevel.toString())
                            : Container(),
                      ],
                    ),
                  )
